...
public class WheatZoomer_UI implements TableCellRenderer {
    ...
    public void init(final Object[][] items, Object[] headers, HashMap<String ,DBData> dbData ,String[] PosRate , double[] cf , HashMap<String , WZ_Dup_info> dupinfo , HashMap<String , String> preCurMap , HashMap<String ,DBData> origin ,ArrayList<String> negative) {
        map = dbData;
